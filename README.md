...
A former Senior Systems engineer, I have extensive experience in leading teams of engineers in the design, analysis and testing of complex satellite structures. I have a methodical, analytical mindset, as well as solid coding processes acquired through Makers, and look forward to being part of a dynamic, agile team, solving new challenges and building innovative digital technology. 
...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | -------------------- |
| [N.E.O.N](https://github.com/even13/game_of_life) | <ul><li>An alternative take on Conways Game of Life simulation, adding 2-player functionality, completed over 10 days, with agile at the core of team processes</li><li>This was my first React Project and provided a fantastic experience to learn managing complex component and state structure in a React application</li><li>The experience gained from this project will help in better planning component structure in the future hence reducing refactoring. Additionally, with such complex state management in the app, Redux would have helped reduce complexity</li></ul>| JavaScript, NodeJS, ReactJS, Jest, Enzyme | Travis CI, Heroku, ESLint, Code Climate     |
...
| [Stocks App](https://github.com/ajbacon/StocksApp) | Personal Project to develop a full-stack JavaScript Application. This build is in its infancy but happy to discuss my plans for it. The focus will be further my knowledge of full stack javascript applications, hitting multiple end-points for a rich user experience.  Well thought-out, thoroughly tested code using CI/CD will be a priority throughout | JavaScript, Express, MongoDB, NodeJS, ReactJS, Jest, Enzyme, Supertest | Travis CI, Heroku, ESLint, Prettier, Code Climate      |
