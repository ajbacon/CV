...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | -------------------- |
| [N.E.O.N](https://github.com/even13/game_of_life) | - An alternative take on Conways Game of Life, introducing a 2 player competative element. Team project with agile methodoligies at the core of team processes
- test out bullet points in a table| JavaScript, NodeJS, ReactJS, Jest, Enzyme | Travis CI, Heroku, ESLint, Code Climate     |
