...
| [Stocks App](https://github.com/ajbacon/StocksApp) | Personal Project to develop a full-stack JavaScript Application. This build is in its infancy but happy to discuss my plans for it. The focus will be well thoughtout, well tested code and built using a solid TDD process | JavaScript, Express, MongoDB, NodeJS, ReactJS, Jest, Enzyme, Supertest | Travis CI, Heroku, ESLint, Prettier, Code Climate      |
