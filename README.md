...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | -------------------- |
| [N.E.O.N](https://github.com/even13/game_of_life) | Final team project. A different take on Conways Game of Life, introducing a 2 player competative element. Developed using agile methodologies.                                                                                                                           | JavaScript, NodeJS, ReactJS, Jest, Enzyme | Travis CI, Heroku, ESLint, Code Climate     |
| [SpaceBook](https://github.com/ajbacon/acebook-true-GrIT) | Team project to build a full stack facebook clone.                                                                                                                                                                                       | Ruby, Rails, ActiveRecord (postgreSQL), RSpec, Capybara | Travis CI, Heroku, Rubocop, Code Climate |
...
| this is project 4 | "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. | Ruby, Sinatra, Bootstrap, OOD | RSpec, Capybara      |
